...
export const TYPE_FIELD_META = {
  ...
  "h-comic": {
    region: {
      label: "Region",
      control: "select",
      options: H_COMIC_REGIONS,
      group: "Classification",
    },
    h_comic_name_cn: { label: "Name (CN)", group: "Names" },
    h_comic_name_en: { label: "Name (EN)", group: "Names" },
    h_comic_name_alt: { label: "Name (Alt)", group: "Names" },
    h_comic_name_jp: { label: "Name (JP)", group: "Names" },
    h_comic_name_kr: { label: "Name (KR)", group: "Names" },
    originality: {
      label: "Originality (JP)",
      control: "select",
      options: H_COMIC_ORIGINALITY,
      group: "Classification",
    },
    animation_status: {
      label: "Animation Status (JP)",
      control: "select",
      options: H_COMIC_ANIMATION_STATUSES,
      group: "Classification",
    },
    // A position in one series - nothing sensible to default it to.
    series_number: {
      label: "Series Number (JP)",
      control: "number",
      group: "Classification",
      defaultable: false,
    },
    ...
    page_total: { label: "Total Pages (JP)", control: "number", group: "Progress" },
    page_fin: { label: "Pages Read (JP)", control: "number", group: "Progress" },
    ch_behind: {
      label: "Chapters Behind Official (KR)",
      control: "number",
      group: "Progress",
    },
    illustrator: {
      label: "繪師",
      control: "tags",
      source: { kind: "person", role: "illustrator", scope: "h-comic" },
      group: "Credits",
    },
    author: {
      label: "Author (KR)",
      control: "tags",
      source: { kind: "person", role: "author", scope: "h-comic" },
      group: "Credits",
    },
    club: {
      label: "Club",
      control: "tags",
      source: { kind: "person", role: "club", scope: "h-comic" },
      group: "Credits",
    },
    original_source: {
      label: "Official Source (KR)",
      control: "tags",
      source: {
        kind: "option",
        category: "Platform",
    ...
    h_genre_plot: {
      label: "Genre Plot",
      control: "tags",
      source: { kind: "option", category: "H Genre Plot", scope: "h-comic" },
      group: "Classification",
    },
    h_genre_appearance: {
      label: "Genre Appearance",
      control: "tags",
      source: { kind: "option", category: "H Genre Appearance", scope: "h-comic" },
      group: "Classification",
    },
    h_genre_relation: {
  ...
  "h-game": {
    ...
    h_game_name_en: { label: "Name (EN)", group: "Names" },
    h_game_name_roman: { label: "Name (Romaji)", group: "Names" },
    h_game_name_jp: { label: "Name (JP)", group: "Names" },
    h_game_name_alt: { label: "Name (Alt)", group: "Names" },
    // A position in one series - nothing sensible to default it to.
    series_number: {
      label: "Series Number",
      control: "number",
    ...
    // The developer is h-game's one credit, a Studio row as on Game.
    studio: {
      label: "Developer",
      control: "tags",
      source: { kind: "studio" },
    ...
    game_genre: {
      label: "Genre",
      control: "tags",
      source: { kind: "option", category: "Game Genre", scope: "h-game" },
      group: "Classification",
    },
    game_theme: {
      label: "Theme",
      control: "tags",
      source: { kind: "option", category: "Game Theme", scope: "h-game" },
      group: "Classification",
    },
    h_genre_plot: {
      label: "Genre Plot",
      control: "tags",
      source: { kind: "option", category: "H Genre Plot", scope: "h-game" },
      group: "Classification",
    },
    h_genre_appearance: {
      label: "Genre Appearance",
      control: "tags",
      source: { kind: "option", category: "H Genre Appearance", scope: "h-game" },
      group: "Classification",
    },
    h_genre_relation: {
      label: "Genre Relation",
      control: "tags",
      source: { kind: "option", category: "H Genre Relation", scope: "h-game" },
      group: "Classification",
    },
    igdb_id: {
      label: "IGDB ID",
