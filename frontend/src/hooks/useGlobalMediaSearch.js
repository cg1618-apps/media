...
// twelve tables and in any franchise. /api/search searches them all in one
...
const ENTRY_TYPES = [
  ...
  "comic",
  "game",
  // The server leaves a gated type's bucket out for a session that cannot
  // see it; a missing bucket reads as empty.
  "h-comic",
  "h-game",
  "hentai",
];
