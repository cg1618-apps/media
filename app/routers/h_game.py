...
mode lacks it. Like Game, it also exposes an IGDB search so the admin can pick
the right entry and store its ID, which is Fill's only handle on it.
"""
...
@router.get("/api/h-game/search-igdb")
def search_igdb(
